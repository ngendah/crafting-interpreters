...
void parser_init(chunk_t *chunk, hash_table_t *hash_table) {
  parser.chunk = chunk;
  parser.hash_table = hash_table;
...
void compiler_string() {
  auto value = value_from_string(parser.previous.lexeme, parser.hash_table);
